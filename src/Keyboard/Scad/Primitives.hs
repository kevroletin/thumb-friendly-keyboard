...
-- | Polyhedron is OpenScad most general 3p primitive which consists of vertexes
-- and surfaces. There are two main difficulties with polyhedron:
--
--     1. faces should have right orientation
--     2. resulting figure should be solid
--     3. vertexes are references by ids
--
-- This
